...
export const updateV2ProtocolData = createAction<{ protocolData: ProtocolData }>('protocol/updateV2ProtocolData')
export const updateChartData = createAction<{ chartData: ChartDayData[] }>('protocol/updateChartData')
export const updateV2ChartData = createAction<{ chartData: ChartDayData[] }>('protocol/updateV2ChartData')
